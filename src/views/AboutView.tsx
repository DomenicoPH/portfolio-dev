    ...
    <div ref={aboutRef} className="flex flex-col justify-center gap-10 h-screen mx-auto bg-gradient-to-b from-black to-gray-900">
      ...
      <div className="flex flex-col xl:flex-row justify-center items-center gap-10 xl:gap-25">
        ...
        <div ref={textRef} className="w-[500px]">
          <h1 className="roboto font-bold text-7xl text-transparent bg-clip-text bg-gradient-to-r from-sky-500 to-fuchsia-100 py-2 mx-10 lg:mx-0 uppercase">
            Sobre mí
          </h1>

          <p className="quicksand text-lg lg:text-2xl text-justify leading-loose text-white mx-10 lg:mx-0">
            Desarrollador Full Stack enfocado en Frontend. Experiencia en el desarrollo de aplicaciones web con HTML, CSS, JavaScript, TypeScript, React y Next.js.
          </p>
          <p className="quicksand text-lg lg:text-2xl text-justify leading-loose text-white mx-10 lg:mx-0">
            Conocimientos en backend con Node.js, Express y bases de datos PostgreSQL.
          </p>

        </div>

        {/* Imagen */}
        <div ref={imageRef} className="w-[400px] sm:w-[400px] aspect-square shadow-black/50 shadow-lg overflow-hidden rounded-full">
          <div className="w-full h-full aspect-square bg-white flex justify-center items-center">
            <Image
              className="object-cover scale-[1.8] ml-12 lg:ml-12 -rotate-3"
              src="/gnomonopic.jpg"
              alt="logo"
              width={2000}
              height={2000}
